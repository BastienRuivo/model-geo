...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/tuto_storage_texture
  OBJDIR = obj/debug/tuto_storage_texture
  DEFINES += -DDEBUG
...
ifeq ($(config),release)
  ...
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/tuto_storage_texture
  OBJDIR = obj/release/tuto_storage_texture
  DEFINES +=
  INCLUDES += -I. -Isrc/gKit
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) ${CUSTOMFILES} $(OBJECTS) $(LDDEPS) $(RESOURCES) | $(TARGETDIR)
	@echo Linking tuto_storage_texture
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning tuto_storage_texture
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/imgui_impl_sdl_gl3.o: src/imgui/imgui_impl_sdl_gl3.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/tuto_storage_texture.o: tutos/tuto_storage_texture.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
