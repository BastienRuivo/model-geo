...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/tuto_englobant
  OBJDIR = obj/debug/tuto_englobant
  DEFINES += -DDEBUG
...
ifeq ($(config),release)
  ...
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/tuto_englobant
  OBJDIR = obj/release/tuto_englobant
  DEFINES +=
  INCLUDES += -I. -Isrc/gKit
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/imgui_impl_sdl_gl3.o: src/imgui/imgui_impl_sdl_gl3.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/tuto_englobant.o: tutos/tuto_englobant.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
